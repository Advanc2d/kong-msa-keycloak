...
<template>
  <header>
    ...
    <div class="menuWrap">
      <ul class="menu">
        <li><a href="javascript:;"><router-link to="/">Home</router-link></a></li>
        <li><a href="javascript:;"><router-link to="/about">About</router-link></a></li>
        <li><a href="javascript:;"><router-link to="/board/list">게시판</router-link></a></li>
